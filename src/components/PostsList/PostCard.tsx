...
import { TimePassed } from '../GameInfo/TimePassed'
...
const PostCard = (props: PostCardProps) => {
  ...
  return (
    <>
      <div
        className={'flex mx-auto w-11/12 sm:mx-0 sm:w-auto flex-col sm:flex-row rounded-[12px] overflow-hidden bg-border-light border border-[2px] border-border-dark'}
      >
        <img
        ...
        <div className={'w-full flex flex-col justify-between p-[20px] '}>
          ...
          <div
            className={'flex gap-[20px] sm:gap-0 flex-col sm:flex-row justify-between'}
          >
            ...
            <div
              className={'w-full sm:w-[150px] flex flex-row justify-between sm:justify-end text-[22px] gap-[15px]'}
            >
