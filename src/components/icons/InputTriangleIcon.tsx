const InputTriangleIcon = (props: { class?: string }) => (
  <svg class={`h-[6px] w-[5px] ${props.class}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 5" fill="none">
    <path
...
export default InputTriangleIcon
